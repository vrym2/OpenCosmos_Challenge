...
class sentinel2_bands:
    ...
    def sentinel_file_paths(self, safe_file_path: str = None, band_type: str = "visual") -> None:
    ...
    def visual_bands(self, band_dict: Dict = None) -> None:
        ...
        loading = Loader(
            "Reading RGB bands into a single file....", "Well, that was fast", 0.05
        ).start()
        with rio.open(
            file_path,
            "w",
