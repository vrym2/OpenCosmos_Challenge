...
class copernicus_api_search:
    ...
    @staticmethod
    def search_date_range(start_date: str = "2022-06-11", end_date: str = "2022-06-22") -> str:
    ...
    def construct_url(
        ...
        search_date_range = copernicus_api_search.search_date_range(
            start_date=search_start_date, end_date=search_end_date
        )
...
@click.command()
@click.option(
    "--max_cloud_percentage", type=np.int16, default=10, help="Maximum cloud cover percentage"
)
...
@click.option(
    "--bbox_str", type=str, default="24.5,42.5,25,43", help="BBox coordinates in a string format"
)
